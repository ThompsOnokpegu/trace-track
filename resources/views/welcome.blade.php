...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full">
    ...
    <body class="h-screen w-screen overflow-hidden flex flex-col font-sans antialiased bg-zinc-50 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100"
          x-data="{ 
    ...
    >
        ...
        <div class="absolute inset-0 z-0 bg-[#041E42]">
        ...
        <main class="relative z-10 flex-1 flex flex-col items-center justify-center px-6 text-center w-full max-w-7xl mx-auto">
